...
export const recipes: Recipe[] = [
  ...
  {
    id: "linte-curry",
    nameRo: "Linte cu legume de sezon",
    nameEn: "Lentils with seasonal vegetables",
    minutes: 30,
    servings: 3,
    tags: ["ieftin", "post", "cina"],
    season: ["ardei", "rosii"],
    perServing: { kcal: 330, protein: 18, carbs: 48, fat: 7 },
    ingredientsRo: [
      "200g linte uscată",
      "1 ardei",
      "2 roșii",
    ...
    stepsRo: [
      "Fierbe lintea.",
      "Călește legumele.",
      "Amestecă și potrivește sarea.",
    ],
    stepsEn: ["Cook the lentils.", "Sauté the vegetables.", "Combine and season."],
    imageHue: 70,
  },
  {
    id: "omleta-telemea",
    nameRo: "Omletă cu telemea și verdeață",
    nameEn: "Omelette with telemea and herbs",
    minutes: 12,
    servings: 1,
    tags: ["mic-dejun", "rapid", "proteina"],
    perServing: { kcal: 320, protein: 22, carbs: 3, fat: 24 },
    ingredientsRo: ["3 ouă", "40g telemea", "mărar / ceapă verde", "1 linguriță ulei"],
    ingredientsEn: ["3 eggs", "40g telemea", "dill / green onion", "1 tsp oil"],
    stepsRo: ["Bate ouăle.", "Adaugă telemeaua.", "Gătește 4–5 minute."],
    stepsEn: ["Beat the eggs.", "Add telemea.", "Cook 4–5 minutes."],
    imageHue: 48,
  },
];
