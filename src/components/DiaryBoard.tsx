...
import { localISO, shiftISO, weekdayKeyFromISO } from "@/lib/dates";
import { useEffectiveGoals, useMetabolism, useRemaining, useTotals } from "@/lib/selectors";
      ...
      {checkInDue(lastCheckInAt, localISO()) && (
        <section className="surface border-brand/40 p-4">
          ...
          <p className="mt-2 text-sm">
            ...
            {report.expenditure != null ? ` · ${t(locale, "expenditure")} ${report.expenditure}` : ""}
          </p>
